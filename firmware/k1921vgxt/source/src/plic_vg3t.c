...
void cache_enable(uint8_t flash, uint8_t ram)
{
	...
	write_csr(SCR_CSR_MPU_SEL, 4); // SDRAM
	write_csr(SCR_CSR_MPU_ADDR, SCR_MPU_MK_ADDR(0x80000000));
	write_csr(SCR_CSR_MPU_MASK, SCR_MPU_MK_MASK(64*1024*1024));
	write_csr(SCR_CSR_MPU_CTRL, 0x0007F);
