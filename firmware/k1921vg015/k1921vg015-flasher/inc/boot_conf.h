...
#define BOOTEN_PORT CONCAT(GPIO, BOOTEN_PORT_LETTER) /*!< Port of  BOOTEN pin  \
                                                      */
#define BOOTEN_PORT_EN                                                         \
  CONCAT(RCU_CGCFGAHB_GPIO, CONCAT(BOOTEN_PORT_LETTER, EN_Msk))
...
#endif
#define BOOTLED_PORT                                                           \
  CONCAT(GPIO, BOOTLED_PORT_LETTER) /*!< Port of  BOOTLED pin */
#define BOOTLED_PORT_EN                                                        \
  CONCAT(RCU_CGCFGAHB_GPIO, CONCAT(BOOTLED_PORT_LETTER, EN_Msk))
...
#define BOOTLED_ALTFUNC                                                        \
  CONCAT(CONCAT(GPIO_ALTFUNCNUM_PIN, BOOTLED_PIN_NUMBER),                      \
         CONCAT(_AF, BOOTLED_ALTFUNC_NUMBER))
/**
 * \note			BOOTLED timer
 */
...
#define BOOTLED_TMR_EN_Msk                                                     \
  CONCAT(RCU_CGCFGAPB_TMR, CONCAT(BOOTLED_TMR_NUMBER, EN_Msk))
...
#define DEBUG_PORT_EN                                                          \
  CONCAT(RCU_CGCFGAHB_GPIO, CONCAT(DEBUG_PORT_LETTER, EN_Msk))
