...
#-- Common flags ---------------------------------------------------------------
SET(COMPILER_COMMON_FLAGS "-mthumb -fno-builtin -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -Wall -ffunction-sections -fdata-sections -mlong-calls")
...
SET(CMAKE_EXE_LINKER_FLAGS "-mthumb -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -mlong-calls -Wl,--gc-sections -specs=nosys.specs -ffreestanding -lnosys -nostartfiles" CACHE STRING "executable linker flags")
...
#-- Debug flags ----------------------------------------------------------------
SET(CMAKE_C_FLAGS_DEBUG "-g -Os -DDEBUG" CACHE STRING "c compiler flags debug")
SET(CMAKE_CXX_FLAGS_DEBUG "-g -Os -DDEBUG" CACHE STRING "c++ compiler flags debug")
...
#-- Release flags ----------------------------------------------------------------
SET(CMAKE_C_FLAGS_RELEASE "-Os -flto=auto -ffat-lto-objects" CACHE STRING "c compiler flags release")
SET(CMAKE_CXX_FLAGS_RELEASE "-Os -flto=auto -ffat-lto-objects" CACHE STRING "c++ compiler flags release")
