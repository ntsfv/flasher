...
# Form implementation generated from reading ui file 'Config3t.ui'
#
...
class Ui_Config3t(object):
    def setupUi(self, Config3t):
        Config3t.setObjectName("Config3t")
        Config3t.resize(534, 607)
        font = QtGui.QFont()
        font.setFamily("DejaVu Sans")
        font.setPointSize(10)
        Config3t.setFont(font)
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(Config3t)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setSpacing(0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.tconfig_frm_cfg = QtWidgets.QFrame(Config3t)
        ...
        self.retranslateUi(Config3t)
        QtCore.QMetaObject.connectSlotsByName(Config3t)

    def retranslateUi(self, Config3t):
        _translate = QtCore.QCoreApplication.translate
        Config3t.setWindowTitle(_translate("Config3t", "Form"))
        self.lbl_warn0.setText(_translate("Config3t", "<html><head/><body><p><span style=\" color:#ef2929;\">Изменяйте состояние конфигурации с осторожностью!</span></p></body></html>"))
        self.lbl_warn0_2.setText(_translate("Config3t", "<html><head/><body><p><span style=\" color:#ef2929;\">Изменения вступят в силу только после сброса контроллера!</span></p></body></html>"))
        self.label.setText(_translate("Config3t", "CFGWORD"))
        self.lbl_flashwe.setToolTip(_translate("Config3t", "<html><head/><body><p align=\"justify\">0 - запрещение записи и стирания основной области Flash-памяти</p><p align=\"justify\">1 - разрешение записи и стирания основной области Flash-памяти</p></body></html>"))
        self.lbl_flashwe.setText(_translate("Config3t", "FLASHWE"))
        self.lbl_jtagen.setToolTip(_translate("Config3t", "<html><head/><body><p>0 - запрещение работы JTAG/SWD функции пина</p><p align=\"justify\">1 - разрешение работы JTAG/SWD функции пина</p></body></html>"))
        self.lbl_jtagen.setText(_translate("Config3t", "JTAGEN"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    Config3t = QtWidgets.QWidget()
    ui = Ui_Config3t()
    ui.setupUi(Config3t)
    Config3t.show()
    sys.exit(app.exec_())
