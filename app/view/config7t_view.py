...
# Form implementation generated from reading ui file 'Config7t.ui'
#
...
class Ui_Config7t(object):
    def setupUi(self, Config7t):
        Config7t.setObjectName("Config7t")
        Config7t.resize(534, 607)
        font = QtGui.QFont()
        font.setFamily("DejaVu Sans")
        font.setPointSize(10)
        Config7t.setFont(font)
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(Config7t)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setSpacing(0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.tconfig_frm_cfg = QtWidgets.QFrame(Config7t)
        ...
        self.retranslateUi(Config7t)
        QtCore.QMetaObject.connectSlotsByName(Config7t)

    def retranslateUi(self, Config7t):
        _translate = QtCore.QCoreApplication.translate
        Config7t.setWindowTitle(_translate("Config7t", "Form"))
        self.lbl_warn0.setText(_translate("Config7t", "<html><head/><body><p><span style=\" color:#ef2929;\">Изменяйте состояние конфигурации с осторожностью!</span></p></body></html>"))
        self.lbl_warn0_2.setText(_translate("Config7t", "<html><head/><body><p><span style=\" color:#ef2929;\">Изменения вступят в силу только после сброса контроллера!</span></p></body></html>"))
        self.label.setText(_translate("Config7t", "CFGWORD"))
        self.lbl_flashwe.setToolTip(_translate("Config7t", "<html><head/><body><p align=\"justify\">0 - запрещение записи и стирания основной области Flash-памяти</p><p align=\"justify\">1 - разрешение записи и стирания основной области Flash-памяти</p></body></html>"))
        self.lbl_flashwe.setText(_translate("Config7t", "FLASHWE"))
        self.lbl_jtagen.setToolTip(_translate("Config7t", "<html><head/><body><p>0 - запрещение работы JTAG/SWD функции пина</p><p align=\"justify\">1 - разрешение работы JTAG/SWD функции пина</p></body></html>"))
        self.lbl_jtagen.setText(_translate("Config7t", "JTAGEN"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    Config7t = QtWidgets.QWidget()
    ui = Ui_Config8t()
    ui.setupUi(Config7t)
    Config7t.show()
    sys.exit(app.exec_())
