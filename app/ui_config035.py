...
class Ui_Config035(object):
    ...
    def retranslateUi(self, Config035):
        ...
        self.lbl_warn0.setText(_translate("Config035", "<html><head/><body><p><span style=\" color:#ef2929;\">Внимание! Изменяйте состояние конфигурации с осторожностью!</span></p></body></html>"))
        self.lbl_cfgword.setText(_translate("Config035", "<html><head/><body><p><span style=\" font-weight:600;\">CFGWORD</span></p></body></html>"))
